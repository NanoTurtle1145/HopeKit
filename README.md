...
> PyQt5 桌面应用脚手架 — MD3 主题 · 可折叠侧边栏 · 插件式模块 · PyInstaller 友好

HopeKit 是一个**开箱即用的 PyQt 桌面应用脚手架**，源自旧项目 HopeTeams-1.6.8 的复活整理。
它不是框架——它是一套作者自己用着爽的模板，把 MD3 主题、侧边栏导航、双模式路径这些反复要写的东西打包好了，拿来就能改。
